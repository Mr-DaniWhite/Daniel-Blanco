  ...
  <tr style="border: none; background: none;">
    <td width="33%" style="vertical-align: top; border: none; padding-right: 15px; padding-top: 0;">
      ...
      <p style="margin: 0 0 20px 0; font-size: 0.9em; line-height: 2.2;">
        ...
        <img src="https://img.shields.io/badge/-IP_Fabric_for_Media-1BA0D7?style=flat&logo=cisco&logoColor=white" height="28" style="vertical-align: middle; margin-right: 6px;"> <strong>Cisco IPFM:</strong> High-performance broadcast IP video/audio matrix architectures.
      </p>
      ...
      <p style="margin: 0; font-size: 0.9em; line-height: 2.2;">
        <img src="https://img.shields.io/badge/-AWS-FF9900?style=flat&logo=amazon-aws&logoColor=white" height="28" style="vertical-align: middle; margin-right: 6px;"> <strong>AWS Cloud:</strong> Core security architecture & transit frameworks.<br>
        <img src="https://img.shields.io/badge/-Azure-0089D6?style=flat&logo=microsoft-azure&logoColor=white" height="28" style="vertical-align: middle; margin-right: 6px;"> <strong>Azure Cloud:</strong> Hub-spoke secure virtual datacenter topologies.
      </p>
    </td>
    <td width="33%" style="vertical-align: top; border: none; padding-right: 15px; padding-left: 15px; padding-top: 0;">
      ...
      <p style="margin: 0; font-size: 0.9em; line-height: 2.2;">
        <img src="https://img.shields.io/badge/-C4_Model-333333?style=flat&logo=diagrams.net&logoColor=white" height="28" style="vertical-align: middle; margin-right: 6px;"> <strong>C4 Model:</strong> Structural software & system architecture abstraction.<br>
        <img src="https://img.shields.io/badge/-PlantUML-4B6F96?style=flat&logo=uml&logoColor=white" height="28" style="vertical-align: middle; margin-right: 6px;"> <strong>PlantUML:</strong> Component-driven text-to-diagram architecture blueprinting.
      </p>
    </td>
